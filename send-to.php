...
<?php require('razorpay-php/Razorpay.php');?>
<?php use Razorpay\Api\Api;?>
<?php $api = new Api("rzp_test_rMlUJsUXaFE4nk", "ZkSwWr3GybCfVLyRDd4FfBGk");?>
<?php
	//IDs
	...
	$(document).ready(function() {
		...
		$("#pay-form").submit(function(e){
			...
			if($('select#email_list').val() == null || $("#recipients").text()=="0")
			{
                ...
                var datapoint = "<?php echo $razorpayOrderId; ?>";
                
                alert($("#grand_total_val").val());
                
                var options = {
                    "key": "rzp_test_rMlUJsUXaFE4nk",
                    "amount": "10000",
                    "currency": "INR",
                    "name": "Acme Corp",
