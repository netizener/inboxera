    ...
    <div class="span10">
			  	...
			  	if ($r && mysqli_num_rows($r) > 0)
			  	{
			  	    while($row = mysqli_fetch_array($r))
			  	    {
		  				...
		  				<tr id="'.$id.'">
			  			  ...
			  			  <td>'.$section_name.'</td>
					      <td><span class="label trigger-action">'.$trigger_name.'</span></td>
					      <td>
					    ...
					    <script type="text/javascript">
					        $("#delete-btn-'.$id.'").click(function(e){
								...
								$("#rule-to-delete").text("'.$campaign_title.'");
								$("#delete-text").val("");
		...
		<div id="delete-rule" class="modal hide fade">
		  ...
		  <div class="modal-body">
		    <p><span id="delete-warning"></span> <?php echo _('Confirm delete <span id="rule-to-delete" style="font-weight:bold;"></span>?');?></p>
		  </div>
