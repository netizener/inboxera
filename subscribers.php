...
<div class="row-fluid">
    ...
    <div class="span10">
    	...
    	<div id="subscribeform" class="modal hide fade" style="width: <?php echo $gdpr_options ? '900' : '516';?>px; margin-left: <?php echo $gdpr_options ? '-450' : '-258';?>px;">
	       ...
	       <p><strong>List ID</strong></p>
	        <p><?php echo _('The following is the List ID');?>:</p>
	            <pre id="list-id"><?php echo short($lid);?></pre>
	        <br/>
...
<script type="text/javascript">
	$(document).ready(function() {
		$("#form-code, #form-url, #list-id").mouseover(function(){
			$(this).selectText();
		});
	});
</script>
...
<div class="modal-body">
    <p><?php echo _('A subscriber\'s \'Last activity\' timestamp is updated when the user:');?></p>
	    <pre><?php echo _('• opened a campaign
