...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo get_app_info('path');?>/css<?php echo $dark_mode ? '/dark' : '';?>/bootstrap.css?30" />
		...
		<link rel="stylesheet" type="text/css" href="<?php echo get_app_info('path');?>/css<?php echo $dark_mode ? '/dark' : '';?>/all.css?32" />
	      ...
	      <div class="navbar-inner">
	        <div class="container-fluid">
	          ...
	          <?php else:?>
		          ...
		          <a class="brand" href="<?php echo get_app_info('path');?>/">Inboxera</a>
