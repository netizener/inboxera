		              ...
		              <td>
		              	...
		              	<div class="btns">
		              		...
		              		<ul class="ares_email_options">
			              		<li><a href="<?php echo get_app_info('path');?>/w/<?php echo short($ares_email_id);?>/a?<?php echo time();?>" title="<?php echo _('Preview');?>" data-placement="bottom" class="iframe-preview btn"><span class="icon icon-eye-open"></span></a></li>
